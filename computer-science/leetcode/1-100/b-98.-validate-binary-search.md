...
[Inorder traversal](../../../tree-traversal.md) means that each node's val should be smaller than the previous one's val if they are in a valid binary search tree.
